/****************************************************************************
** Meta object code from reading C++ file 'CameraSettingsWindow.hpp'
**
...
#include <memory>
#include "../../../src/CameraSettingsWindow.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'CameraSettingsWindow.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CameraSettingsWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_CameraSettingsWindow_t qt_meta_stringdata_CameraSettingsWindow = {
    {
QT_MOC_LITERAL(0, 20) // "CameraSettingsWindow"
...
const QMetaObject CameraSettingsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CameraSettingsWindow.offsetsAndSize,
    qt_meta_data_CameraSettingsWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_CameraSettingsWindow_t
, QtPrivate::TypeAndForceComplete<CameraSettingsWindow, std::true_type>
