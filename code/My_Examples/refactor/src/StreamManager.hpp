...
public:
    ...
    void streamFromDevice(std::shared_ptr<Camera> camera, bool save_footage);
    void startSyncFreeRun(const std::list<std::shared_ptr<Camera>> &OpenCameras, bool save_footage);
